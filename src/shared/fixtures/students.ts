...
export const fixtureStudents: Student[] = [
  { id: 'student-anna', tutorId: fixtureOwnCalendarId, name: 'Anna Koval', subject: 'Mathematics', paidLessonsLeft: 2 },
  { id: 'student-petro', tutorId: fixtureOwnCalendarId, name: 'Petro Melnyk', subject: 'Algebra', paidLessonsLeft: 1 },
  { id: 'student-sofia', tutorId: fixtureOwnCalendarId, name: 'Sofia Bondar', subject: 'Geometry', paidLessonsLeft: 8 },
  { id: 'student-maksym', tutorId: fixtureOwnCalendarId, name: 'Maksym Zhuk', subject: 'Mathematics', paidLessonsLeft: 5 },
  { id: 'student-ivan', tutorId: fixtureOwnCalendarId, name: 'Ivan Shevchenko', subject: 'Mathematics', paidLessonsLeft: 12 },
  { id: 'student-mariia', tutorId: fixtureOwnCalendarId, name: 'Mariia Tkachenko', subject: 'Mathematics', paidLessonsLeft: 4 },
  { id: 'student-yaroslav', tutorId: fixtureOwnCalendarId, name: 'Yaroslav Bilyk', subject: 'Mathematics', paidLessonsLeft: 6 },
